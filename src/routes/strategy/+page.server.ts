...
const strategies = [
  ...
  'A very small object<br/>-Its centre',
  'Abandon desire',
  ...
  "Children's voices<br/>-speaking<br/>-singing",
  'Cluster analysis',
  'Consider different fading systems',
  'Consider transitions',
  'Consult other sources<br/>-promising<br/>-unpromising',
  ...
  'Idiot glee',
  'Imagine the system a moving chain or caterpillar',
  'Imagine the system as a series of disconnected events',
  'In total darkness, or in a very large room, very quietly',
  'Infinitesimal gradations',
  'Instead of changing the thing, change the world around it.',
  'Intentions<br/>- credibility of<br/>- nobility of<br/>- humility of',
  'Into the impossible',
  'Is it finished?',
  ...
  'Lowest common denominator check<br/>-single beat<br/>-single note<br/>-single riff',
  ...
  'The source is now the system',
  'Think<br/>-inside the work<br/>-outside the work',
  'Think of the radio',
  'Tidy up',
